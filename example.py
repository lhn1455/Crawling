...
class WindowClass(QMainWindow, UI_class) :
    ...
    def ReviewCrawlingFunction(self) :
        ...
        driver = webdriver.Chrome("/Users/hannaleee/Desktop/chromedriver")
        ...
        login_pw = driver.find_element("input#user_password")
        ...
        #원하는 회사의 리뷰 페이지까지 이동
        company = driver.find_element(By.CSS_SELECTOR, "input#search_bar_search_query")
        ...
        review_cnt_raw = driver.find_element(By.CSS_SELECTOR, "span.num.notranslate")[1]
        ...
        for i in range(review_page): 
            ...
            #직무, 근속여부, 지역 ,일시
            user_info = driver.find_element(By.CSS_SELECTOR, "span.txt1")
            ...
            #별점
            stars = driver.find_element(By.CSS_SELECTOR, "div.star_score")
            for j in stars:
            ...
            #요약 정보
            summery = driver.find_element(By.CSS_SELECTOR,"h2.us_label")
            ...
            review = driver.find_element(By.CSS_SELECTOR, "dd.df1")
